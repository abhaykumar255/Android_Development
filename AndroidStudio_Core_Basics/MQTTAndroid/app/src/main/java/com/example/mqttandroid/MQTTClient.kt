...
class MQTTClient(
    ...
    // used to communicate with the mqtt server
    ...
    private val defaultCbConnect = object : IMqttActionListener{
        override fun onSuccess(asyncActionToken: IMqttToken?) {
            Log.d(this.javaClass.name,"Connected Successfully")
        }
    ...
    private val defaultCbSubscribe = object : IMqttActionListener{
        override fun onSuccess(asyncActionToken: IMqttToken?) {
            Log.d(this.javaClass.name,"Subscribe to topic")
        }
    ...
    private val defaultCbUnsubscribe = object : IMqttActionListener{
        override fun onSuccess(asyncActionToken: IMqttToken?) {
            Log.d(this.javaClass.name,"Unsubscribe to topic")
        }
    ...
    cbSubscribe  :IMqttActionListener = defaultCbSubscribe){
        try {
            mqttClient.subscribe(topic,qos,null,cbSubscribe).actionCallback = object : IMqttActionListener {
                override fun onSuccess(asyncActionToken: IMqttToken?) {
